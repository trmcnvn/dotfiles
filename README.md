...
| Machine setup | [Mise configuration](config/config.toml) · [Setup tasks](config/tasks) |
...
Tool versions stay pinned in `config/config.toml`; update those pins deliberately.
