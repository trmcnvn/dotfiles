...
| Tool                    | Best For                                                        |
| ----------------------- | --------------------------------------------------------------- |
| **opensrc_execute**     | Fetch full source for deep exploration (npm/pypi/crates/GitHub) |
| **grep_app_searchGitHub** | Find patterns across public GitHub repos                     |
...
| **webfetch**            | Fetch exact known URLs (docs, changelogs, release notes)        |

### When to Use Each

- **opensrc_execute**: Deep exploration of specific repos, comparing implementations, reading actual source
- **grep_app_searchGitHub**: Finding how real projects use a library pattern across many repos
...
- **codesearch**: Quick code examples and API patterns for frameworks/libraries
- **webfetch**: Fetch exact pages when you already know the URL

Never refer to tools by name in your response. Say "I'll read the source" not "I'll use opensrc_execute."
